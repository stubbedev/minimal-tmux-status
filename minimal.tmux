...
status_left=$(get_tmux_option "@minimal-tmux-status-left" "#[bg=default,fg=black,bold]#{?client_prefix,,${indicator}}#[bg=${bg},fg=black,bold]#{?client_prefix,${indicator_active},}#[bg=default,fg=black,bold]")
